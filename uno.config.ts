...
export default defineConfig({
  ...
  safelist: ['i-carbon-code', 'i-carbon-home', 'i-carbon-user', 'i-carbon-gift', 'i-carbon-shopping-cart', 'i-carbon-shopping-bag', 'i-carbon-delivery', 'i-carbon-drink-01', 'i-carbon-group'],
  rules: [
    [
      'p-safe',
      {
