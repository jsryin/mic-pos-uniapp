...
export default defineConfig({
  ...
  safelist: ['i-carbon-code', 'i-carbon-home', 'i-carbon-user', 'i-carbon-gift', 'i-carbon-shopping-cart', 'i-carbon-shopping-bag', 'i-carbon-delivery', 'i-carbon-drink-01', 'i-carbon-group', 'i-carbon-document', 'i-carbon-restaurant', 'i-carbon-information', 'i-carbon-phone', 'i-carbon-location', 'i-carbon-chevron-down', 'i-carbon-refresh', 'i-carbon-close', 'i-carbon-user-avatar-filled'],
  rules: [
    [
      'p-safe',
      {
